...
class Email{
    ...
    public static function emailAlterarSenhaAssinante($EMAIL, $HASH)  {

        $EmailSendObj = new EmailSend();
        $ALTBODY = "Redefina a sua senha acessando: https://app.smilecopilot.com/ativacaoAssinante?id=$HASH";
        $SUBJECT = "SmileCopilot – Redefinição de Senha";
        ...
        $MSG = <<<HTML
                ...
                <head>
                <meta charset="UTF-8">
                <title>Redefinição de Senha - SmileCopilot</title>
                <style>
                    body {
                        background-color: #f4f7fb;
                        font-family: Arial, Helvetica, sans-serif;
